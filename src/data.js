export const projects = [
  ...
  },
  {
    ...
    description: "A simple clicker game where users mine ore",
  ...
  },
  {
    ...
    subtitle: "Python",
    description: "Python application that allows users to determine rankings of videos based on the ELO rating system",
  ...
  },
  {
    ...
    description: "Python application that converts PDF documents to playable audio files utilizing the Google Cloud API",
    image: "./tts.png",
    link: "",
  },
];
