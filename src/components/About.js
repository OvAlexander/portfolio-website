      ...
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center text ">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center text-white">
          ...
          <div className="flex justify-center">
            ...
            <a
              href="#projects"
              className="ml-4 inline-flex bg-blue-800 border-0 py-2 px-6 focus:outline-none hover:bg-blue-500 rounded text-lg"
            >
              Projects
            </a>
          </div>
        </div>
        <div className="lg:max-w-sm lg:w-full md:w-1/2 w-5/6 rounded-lg border-8 border-transparent overflow-hidden transition-all duration-300 hover:border-black">
          <a
